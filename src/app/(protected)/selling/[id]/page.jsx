...
export default function MarketDetailPage() {
  ...
  const [editTotalCount, setEditTotalCount] = useState(cardData.total);
  const [editPrice, setEditPrice] = useState(cardData.price * 5);
        ...
        <main className="max-w-[1080px] mx-auto px-6 py-8">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="border border-[#3f3f3f] rounded-lg min-h-[260px]" />
            </div>
          </section>
        </main>
      </div>
